...
public class UserAgreementandSSSActivity extends AppCompatActivity {
    ...
    public void setItemSSS() {
        sssItemList.add(new SSSItem("SelfieWars Nedir?\n", "SelfieWars temelde tahmin yapma üzerine kurulu bir mobil oyundur. " +
                "Karşına çıkan kişilerin fotoğraflarına bakarak tahminler yaparsın ve tahminlerden kazandığın puanlarla haftalık ödülleri kazanma fırsatı yakalarsın. " +
        ...
        sssItemList.add(new SSSItem("Kazandığım puanlar ne işime yarar?\n", "Tahminlerden kazandığın puanlarla haftalık ödüllere bir adım daha yaklaş! "));
        ...
        sssItemList.add(new SSSItem("Hafta bitiminde puanlar sıfırlanır mı?\n", "Her hafta puanlar sıfırlanır ve haftanın ödülleri değişir.\n"));
